...
-- 退出终端插入模式
vim.keybinds.gmap("t", "<Esc>", "<C-\\><C-n>", vim.keybinds.opts) -- This is trivial, no which-key.
-- -- 打开普通终端
...
wk.register({
    t = {
        name = "Terminal",
        t = { "<cmd>exe v:count.'ToggleTerm'<CR>", "Open terminal"},
        f = { "<cmd>lua require('toggleterm').float_toggle()<CR>", "Open floating terminal"},
