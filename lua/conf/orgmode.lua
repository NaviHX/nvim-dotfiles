...
local Config = {
  ...
  org_todo_keywords = { 'TODO(t)', 'WAIT(w)', '|', 'DONE(d)', 'DELEGATED(r)' },
  ...
  org_capture_templates = {
    c = {
      description = 'Capture',
      template = '* TODO %?\n  %u',
      target = "~/org/captures.org",
    },
    t = {
        description = 'Task',
        template = '* TODO %?\n',
        target = "~/org/todo/general.org",
    },
  },
  ...
  mappings = {
    ...
    org = {
      ...
      org_change_date = '<prefix>cid',
      org_priority = '<prefix>,',
      org_priority_up = '<prefix>ciR',
      org_priority_down = '<prefix>cir',
      org_todo = '<prefix>cit',
      org_todo_prev = '<prefix>ciT',
      org_toggle_checkbox = '<prefix>cix',
